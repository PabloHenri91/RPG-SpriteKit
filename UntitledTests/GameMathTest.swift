...
class GameMathTest: XCTestCase {
    ...
    func testXP() {
        ...
        character.update(xp: 1959 - 1 + 2743)
        XCTAssertEqual(5, character.level)
        XCTAssertEqual(0, character.xp)
        
        character.update(xp: 12347669)
        XCTAssertEqual(26, character.level)
        XCTAssertEqual(1107585, character.xp)
        
        XCTAssertEqual(1000, GameMath.xp(level: 1))
        XCTAssertEqual(1400, GameMath.xp(level: 2))
        XCTAssertEqual(1959, GameMath.xp(level: 3))
        XCTAssertEqual(2743, GameMath.xp(level: 4))
        XCTAssertEqual(3841, GameMath.xp(level: 5))
        XCTAssertEqual(5378, GameMath.xp(level: 6))
        XCTAssertEqual(7529, GameMath.xp(level: 7))
        XCTAssertEqual(10541, GameMath.xp(level: 8))
        XCTAssertEqual(14757, GameMath.xp(level: 9))
        XCTAssertEqual(20661, GameMath.xp(level: 10))
        XCTAssertEqual(28925, GameMath.xp(level: 11))
        XCTAssertEqual(40495, GameMath.xp(level: 12))
        XCTAssertEqual(56693, GameMath.xp(level: 13))
        ...
        XCTAssertEqual(426878, GameMath.xp(level: 19))
        XCTAssertEqual(597630, GameMath.xp(level: 20))
        XCTAssertEqual(836682, GameMath.xp(level: 21))
        XCTAssertEqual(1171355, GameMath.xp(level: 22))
        XCTAssertEqual(1639897, GameMath.xp(level: 23))
        XCTAssertEqual(2295856, GameMath.xp(level: 24))
        XCTAssertEqual(3214199, GameMath.xp(level: 25))
        XCTAssertEqual(4499879, GameMath.xp(level: 26))
        XCTAssertEqual(6299831, GameMath.xp(level: 27))
        XCTAssertEqual(8819763, GameMath.xp(level: 28))
        XCTAssertEqual(12347669, GameMath.xp(level: 29))
    }
